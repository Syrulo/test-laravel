...
@section('content')
    ...
    <div class="flex justify-center items-center h-screen m-0 flex-col">
        <form action="{{ route('books.store') }}" method="POST" class="w-96">
            ...
            <label for="genre_id" class="block text-white text-xl font-semibold mb-2">Catégorie :</label>
            <select class="text-black px-4 py-2 border border-gray-300 rounded-lg w-full mb-4" name="genre_id" required>
