...
@section('content')
    <div class="flex justify-center items-center text-center h-screen m-0 flex-col">
        <h1 class="text-xl text-black font-bold">Bienvenue dans ce projet de librairie interactive</h1>
